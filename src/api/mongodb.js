...
export const EventMaterial = mongoose.model('EventMaterial', eventMaterialSchema);
export const EventSupplier = mongoose.model('EventSupplier', eventSupplierSchema);
export const TaskCategory = mongoose.model('TaskCategory', taskCategorySchema);
export const MaterialCategory = mongoose.model('MaterialCategory', materialCategorySchema);
