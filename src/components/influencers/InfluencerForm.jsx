...
import { Image, Upload, DollarSign, Instagram, Percent } from "lucide-react";

export default function InfluencerForm({ initialData, onSubmit, onCancel }) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Informações gerais sobre o influenciador, nicho, público-alvo..."
              className="h-24"
            />
          </div>
        </div>
      ...
      <div className="flex justify-end gap-3">
        ...
        <Button type="submit" className="bg-blue-600 hover:bg-blue-700">
          {initialData ? "Atualizar" : "Criar"} Influenciador
        </Button>
      </div>
    </form>
  );
